        ...
        if "access_token" in result:
            for folder in get_folders(hosp, deferred):
                ...
                while 1:
                    ...
                    flag = 1
                    query = f'https://graph.microsoft.com/v1.0/users/{email}/messages?$search="0000000019764770_2020"'
...
def imap_(data, hosp, deferred):
    try:
        ...
        for folder in get_folders(hosp, deferred):
            ...
            _, message_numbers_raw = imap_server.search(None, f'(TEXT "MANIK CHAN BEGUM")')
...
if __name__ == '__main__':
    imap_(hospital_data['ils_agartala'], 'ils_agartala', '')
    pass